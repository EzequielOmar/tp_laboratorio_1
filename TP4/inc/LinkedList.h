 ...
 * \return void* Retorna    (NULL) Error: si el puntero a la lista es NULL o (si 
 * el indice es menor a 0 o mayor al len de la lista)
                            (pElement) Si funciono correctamente
 *
 */
 ...
 * \return int Retorna  (-1) Error: si alguno de los punteros a las listas son NULL
                        ( 1) Si los elementos de (this2) estan contenidos en la lista
 ...
 * \return LinkedList* Retorna  (NULL) Error: si el puntero a la listas es NULL
                                ...
                                o (si el indice to es menor o igual a from o mayor al len de 
                                la lista)
